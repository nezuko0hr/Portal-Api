...
const localizeKeyword = (keyword: any, lang: string = "en") => ({
  _id: keyword._id,
...
const validateKeywordInput = (word: any, res: Response): void => {
  const conflicts: any = {};
...
export const createKeywordController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
...
// Get all keywords
export const getAllKeywordsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
  try {
    ...
    const localizedData = keywords.map((k: any) => localizeKeyword(k, lang));
...
// Get keyword by ID
export const getKeywordByIdController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
...
// Update keyword
export const updateKeywordController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
  try {
    ...
    if (word.en !== existingKeyword.word?.en) {
      ...
      (existingKeyword as any).slug = newSlug;
    }

    (existingKeyword as any).word = word;
...
// Delete keyword
export const deleteKeywordController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
